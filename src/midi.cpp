...
// -----------------------------------------------------------------------------
void OnAppleMidiCc(byte channel, byte controlNumber, byte controlValue ){
...
void OnSerialMidiCC (byte channel, byte controlNumber, byte controlValue )
{
...
void setup()
{
  ...
  AppleMIDI.begin("test");                            // rtpMIDI session name
